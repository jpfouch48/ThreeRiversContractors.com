...
<nav class="navigation pagination woocommerce-pagination">
	...
	<h2 class="screen-reader-text"><?php printf( '%s navigation', $post_type_label ); ?></h2>

	<div class="paging-nav-text"><?php printf( 'Page %1$d of %2$d', max( 1, get_query_var( 'paged' ) ), absint( $wp_query->max_num_pages ) ); // xss ok. ?></div>
